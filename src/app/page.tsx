      ...
      <main className="max-w-screen-2xl m-auto bg-white">
        ...
        {/* DESCRIPTION */}
            ...
            <div className='flex flex-wrap'>
              <img className='w-56 h-44 mr-1 mb-1 object-cover' src="https://resizer.otstatic.com/v2/photos/xlarge/2/50334381.jpg" alt="" />
              <img className='w-56 h-44 mr-1 mb-1 object-cover' src="https://resizer.otstatic.com/v2/photos/xlarge/2/50334382.jpg" alt="" />
              <img className='w-56 h-44 mr-1 mb-1 object-cover' src="https://resizer.otstatic.com/v2/photos/xlarge/2/50334383.jpg" alt="" />
              <img className='w-56 h-44 mr-1 mb-1 object-cover' src="https://resizer.otstatic.com/v2/photos/xlarge/2/50334388.jpg" alt="" />
              <img className='w-56 h-44 mr-1 mb-1 object-cover' src="https://resizer.otstatic.com/v2/photos/xlarge/2/50334385.jpg" alt="" />
            </div>
            {/* IMAGES */}
        </div>
        </div>
